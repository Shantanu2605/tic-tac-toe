...
/>
   ...
   <div className="w-[80%] flex justify-between mx-auto mt-5">
       <div className="box w-[45%] bg-black flex justify-between text-white font-[Orbitron]">
          <div className='flex gap-3'><img src="person.svg" alt="" />
   ...
   <div className="bg-black mt-4 w-[50%] mx-auto flex flex-col items-center">
    ...
    <div className="button flex flex-col gap-4 w-[50%] mx-auto mt-4 justify-center items-center">{win&&<button><a href="" className='bg-[#219b21] hover:bg-[#0c560c] text-white px-2 py-2 font-[Roboto] rounded-md'>Play Again</a></button> }
